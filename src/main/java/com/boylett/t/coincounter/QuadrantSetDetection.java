...
public class QuadrantSetDetection {
    ...
    public static class Builder {
        ...
        public Builder setMinContLen(int minContLen) {
            if (minContLen < com.boylett.t.coincounter.KeyPoint.LENGTH) {
                throw new InvalidParameterException("Minimum contour length must be atleast " + com.boylett.t.coincounter.KeyPoint.LENGTH);
            }
            this.minContLen = minContLen;
            return this;
        }
    ...
    private boolean morePixelsAbove(MatOfPoint contour) {
        ...
        Mat testImg = new Mat(boundBox.height, boundBox.width, CV_8UC1, RGB.white);
    ...
    private int countPixels(boolean above, Mat img, Mat mask) {
        ...
        Imgproc.floodFill(copy, mask, seed, RGB.black);
